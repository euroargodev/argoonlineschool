...
If you have a question about the Argo Online School (AOS), how to use it, or just need clarification about something:

* Open an Issue at https://github.com/euroargodev/argoonlineschool/issues
* Provide as much context as you can about what you're running into.
* Provide lesson and chapter versions, depending on what seems relevant. If not, please be ready to provide that information if maintainers ask for it.
...
* The AOS team will [label the issue](#label-issues).
...
If the AOS team doesn't do something you need or want it to do:
...
* The AOS team will [label the issue](#label-issues).
* The AOS team will evaluate the feature request, possibly asking you more questions to understand its purpose and any relevant requirements. If the issue is closed, the AOS team will convey their reasoning and suggest an alternative path forward.
...
Note: The AOS team is unlikely to be able to accept every single feature request that is filed. Please understand if they need to say no.
...
Documentation is a super important, critical part of the AOS. Docs are how we keep track of what we're doing, how, and why. It's how we stay on the same page about our policies. And it's how we tell others everything they need in order to be able to use the AOS -- or contribute to it. So thank you in advance.
...
* Go to https://github.com/wealljs/weallcontribute/pulls and open a new pull request (PR) with your changes.
...
* Go to https://github.com/euroargodev/argoonlineschool/pulls and open a new pull request with your changes.
* If your PR is connected to an open issue, add a line in your PR's description that says `Fixes: #123`, where `#123` is the number of the issue you're fixing.
...
Helping out other users with their questions is a really awesome way of contributing to the Argo community. It's not uncommon for most of the issues on an open source projects being support-related questions by users trying to understand something they ran into, or find their way around a known bug.
...
* Go to the issue tracker and [filter open issues by the `support` label](https://github.com/euroargodev/argoonlineschool/issues?q=is%3Aopen+is%3Aissue+label%3Asupport).
...
While anyone can comment on a PR, add feedback, etc, PRs are only *approved* by AOS team members with Issue Tracker or higher permissions.
...
* Please make sure you're familiar with the code or documentation being updated, unless it's a minor change (spellchecking, minor formatting, etc). You may @mention another AOS member who you think is better suited for the review, but still provide a non-approving review of your own.
...
All of the below positions are granted based on the AOS team's needs, as well as their consensus opinion about whether they would like to work with the person and think that they would fit well into that position. The process is relatively informal, and it's likely that people who express interest in participating can just be granted the permissions they'd like.

You can spot a collaborator on the repo by looking for the `[Collaborator]` or `[Owner]` tags next to their names.

Permission | Description
--- | ---
Issue Tracker | Granted to contributors who express a strong interest in spending time on the AOS's issue tracker. These tasks are mainly [labeling issues](#label-issues), [cleaning up old ones](#clean-up-issues-and-prs), and [reviewing pull requests](#review-pull-requests), as well as all the usual things non-team-member contributors can do. Issue handlers should not merge pull requests, tag releases, or directly commit code themselves: that should still be done through the usual pull request process. Becoming an Issue Handler means the AOS team trusts you to understand enough of the team's process and context to implement it on the issue tracker.
Committer | Granted to contributors who want to handle the actual pull request merges, tagging new versions, etc. Committers should have a good level of familiarity with the codebase, and enough context to understand the implications of various changes, as well as a good sense of the will and expectations of the AOS team.
Admin/Owner | Granted to people ultimately responsible for the AOS, its community, etc.
