# <img src="http://www.argo.ucsd.edu/argocolorsmall.gif" alt="Argo status" width="150"/> Argo data
...
<img src="http://www-hrx.ucsd.edu/www-argo/status.gif" alt="Argo status" width="650"/>
...
##  the netCF format
When an Argo float surfaces, the data are sent to the Argo Data System where it will ne processed and made available for everyone, free of charge. Here will will describe the neccesary infiramton to understand and be able to use these data.
