...
Lets use data in the *Atlantic for the 11th November 2019. It is pre-downloaded in the ./Data folder, but you can dowload it from the Coriolis GDAC (See here for isntruction of how to dowload the data)
...
and it is possible to get the WMO of all the platforms than measured in this month, together with its data acquisition center, hence, if necccesart we can dowload the netcdf files for each cycle:
...
We can examine also the profiles of salinity, just for a single day of data in the Atlantic:
