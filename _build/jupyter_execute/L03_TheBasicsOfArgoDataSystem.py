# <img src="./images/logoArgo.png" alt="Argo status" width="150"/> Argo Data System
...
- a *dac* folder which sorts the data by Data Assembly Centre and float
- a *geo* folder which sorts the data by ocean basin and date
