...
# 
# ## Data
# If you download the notebooks you should create a ./Data* folder where include the files used for the examples. The files in the Data folder can be dowloaded from [here](https://www.oceanografia.es/argoonlineschool/Data/) or directly from its source using _wget_:
# 
